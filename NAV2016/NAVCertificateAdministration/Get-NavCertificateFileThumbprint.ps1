<#
.SYNOPSIS
   This cmdlet facilitates the extraction of a certificate thumbprint from a .cer file
...
#>
function Get-NavCertificateFileThumbprint
{
    [CmdletBinding()]
    PARAM(
    ...
    PROCESS
    {
        if (![System.IO.Path]::IsPathRooted($CertificateFilePath))
        {
            $CertificateFilePath = Join-Path $(Get-Location).Path $CertificateFilePath
        }
        
        # Test if the provided file exists
        if (!(Test-Path -PathType Leaf $CertificateFilePath))
        {
            Write-Error "Could not locate certificate"
            return
        }
...
Export-ModuleMember Get-NavCertificateFileThumbprint
# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUczHs0aW3DrrlU/983x3yPl2H
# s6GgghWCMIIEwzCCA6ugAwIBAgITMwAAAIliDZ6V02FrqAAAAAAAiTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFMeN
# /AR+iaAUDI25Hcneld9t+aYRMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAowafbYKTgwYapxq5UW9f+
# iXN2NgrMRePZHhBwsqW6JQJTaz42FfASZKbdhneAFgycEcL+hEXAQoFAY20eboDC
# tQeeFr0bU7+Q+g5qoi9Q4PAJ+fhVmUzZ1DprUNYM7yERtqApiqXrRrK0U/3pl0U2
# oOodUiBva3f0us1OCxLlETn9RNgcjLVmoDo2/JLISBClGqjwCWEr/QzIDsBKiZI/
# WNzaOdeuLdVTzlQ7iwzCATaXN2n42WQyp4uwi6TzeAfmtLBC7IyBvAntOYk3pVPK
# QrSe90EblJ+62yh0dVLBIJ4ZzEy2Qajr/s15EooZRzKqQLIs55PLaGB+inqHq6mk
...
# NDI2WjAjBgkqhkiG9w0BCQQxFgQUZxXbJ1I1x4RDFyN/yjK9pPw39DEwDQYJKoZI
# hvcNAQEFBQAEggEAVwRw/hrSDmf7Vw/WPBveZ1cvBWnraj6pJ/ys+bk/KudoEIsi
# M8bMSyW+yfQi/99reEpLo4X+hCR30eomT8OCp42howCaBC7T9cFGiubww0V4QYmX
# tDmWNlkbFWZpcFookvlOtM7HxRMmFINudWmuK5qXRxV3cvCXK6yxgUTU9dEm8sXt
# OM8Qh6VAZ4BlO/J1gkqgybvTpb7tnODVX9DgbKSSHAXu2ugd134F2hBWSqoNw2mS
# JIRcL+EBUS/LcuW43u5WpzrZWp8VcxWGFGAU2mpioW6N6HboBJI34n/Nd4PDa3QE
# QLAAMe76neSsqaauonY/9b6VUVPv3nnwEtL2fg==
