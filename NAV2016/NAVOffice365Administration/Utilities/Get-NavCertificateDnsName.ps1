<#
.SYNOPSIS
   This cmdlet facilitates the extraction of a certificate Dns name from an installed certificate

.DESCRIPTION
   This cmdlet facilitates the extraction of a certificate Dns name from an installed certificate
.PARAMETER CertificateThumbprint
    The thumbprint of an installed certificate
#>
function Get-NavCertificateDnsName
{
    [CmdletBinding()]
    PARAM(
    ...
    PROCESS
    {
        # Find the certificate in the LocalMachine\My store with the provided thumbprint
        $certificate = Get-ChildItem -Path Cert:\LocalMachine\My | where { $_.Thumbprint -eq $CertificateThumbprint } | select
        if (!$certificate)
        {
            # Could not find a certificate matching the thumbprint
            Write-Error "Could not find an installed certificate with the specified thumbprint in the expected location."
            return
        }

        return $certificate.GetNameInfo([System.Security.Cryptography.X509Certificates.X509NameType]::DnsName,$false)
    }
}

Export-ModuleMember Get-NavCertificateDnsName
# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUx+98evh5RPrBpeISe1q/B4a9
# nUOgghWCMIIEwzCCA6ugAwIBAgITMwAAAIliDZ6V02FrqAAAAAAAiTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFOcn
# BV1HouVT5m7fRLPCzKtYnPftMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBwfdE3TqPFSwjEfrH8pIOG
# iImlEAIMpMAP66QkyJE4SppeYcsqrpm4ea5IcSmewOd3vOeFBb86vzWOI6QMj5UI
# VdQc6BbNfXKfQ1OFXwUplJAZwBFIJVtDZfyYaMUc5F9pwscFOQub835kDKOtTie0
# S8wby8RlUWZrC228FV8ONyrqo6ZDUXJEgF28FqT/MHEt3wmokR1EIeVaM92TwUmB
# CbZSOMuwkayTsgttECdsnmZon3fAv8POCYoGqwKmpA+r4J2YU22+Vpnmh6SyngNu
# yFGmziF0ZGC/rLzD4GE97Ep7nMDs707AlEvY2tpjd5AEJumbUyM3dV7WheFLbUwP
...
# NDI2WjAjBgkqhkiG9w0BCQQxFgQUhMR0bOOB8xr+xn7mvxkBoMW0UDYwDQYJKoZI
# hvcNAQEFBQAEggEAaUFRsoVblwBhHEqg8IL2FLX72gnmDkHLjJIFcXcEEdmxk9nu
# jMKZASXnjqvLQncjTjY994JIHUyWzesIJQL3SvwM/OQ47GZ72UMhfyXYk21N5Eud
# 5UW9j0YWprVJ+CIB3UQRjtq1P6Ky/sQPl2AjQm8w2IE5LuXwX6SDlqYfn7c7AQCT
# KaIyk4oq/3KU+xkeZR1cMx7JpIeb8fEZ/0BblT7/gXHtL/31k9fb1NgPFGwBs7iS
# Od5nwCMCzocEsJA/2EvL11MZTRR6RpRiMaTQ3GtSlAtzVYNRN3kBzC8dpYl4xVsf
# IacZt6gpvjduMixcLLIEE856+m8RHeWiclmzrg==
