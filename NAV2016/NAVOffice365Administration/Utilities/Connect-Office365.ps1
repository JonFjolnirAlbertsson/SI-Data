<#
 .SYNOPSIS
   This cmdlet connects to the Microsoft Online service in order to perform Windows Azure Active Directory - related actions.

 .DESCRIPTION
   This cmdlet connects to the Microsoft Online service in order to perform Windows Azure Active Directory - related actions.

 .PARAMETER Office365UserName
   The Office 365 user name (email address).
 .PARAMETER Office365Password 
   The Office 365 password.
#>
function Connect-Office365
{
    ...
    PROCESS 
    { 
        $credentialInfoMessage = "Please enter your Office 365 user name and password:"

        if (!$Office365Password -and !$Office365UserName)
        {
            $office365Credentials = Get-Credential -Message $credentialInfoMessage
        }
        elseif (!$Office365Password)
        {
            $office365Credentials = Get-Credential -UserName $Office365UserName -Message $credentialInfoMessage
        }
        elseif (!$Office365UserName)
        {
            Write-Error "Please provide a valid Office 365 user name (email address) for the password you have just provided."
        }
        else
        {
            $office365Credentials = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $Office365UserName, $Office365Password        
        }
        ...
        Write-Verbose "Successfully connected to the AAD tenant: $domain"
...
Export-ModuleMember Connect-Office365

# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOaUpowWVoFrKowbibClbAbF9
# H6egghWCMIIEwzCCA6ugAwIBAgITMwAAAIpX6omjSeuL6AAAAAAAijANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJiD
# RGvygHPCRR0AohyfEQcPod6cMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQA7cF89DooiSzSllecGqS7s
# 1QVKUt15DQ4MEN14H7pTjQk++xP+0Obk6Py1aNmffitOV3sp1jG5+gBRhb5mkH4Z
# +Je0imh4Om9MTOM+tAUpJ9eqHY4LNWu+7OFTRNt77XlC2h98WU0JeVfbhqoP2Af4
# zTqCMEDMMTcFOzZ+hAOHwf6kZYiOq2gMqyXE+S1Ra9+g58G8h1FH5wR+RviriuZj
# d0ic7VgBEbctIKVWeBeNBG9QsL0JsY2WPs+Ifh6J8Wrcn077ebZNswyinvDbqSGp
# aZhNFna56uX8wc/KjeUjXgz6aTycCpRC0EvJkmMWrmtAxdcxR7+r6/tF2rH4/Slj
...
# NDI1WjAjBgkqhkiG9w0BCQQxFgQU1b+YBBjsMsOmOzDY6dq1K1ZIGDswDQYJKoZI
# hvcNAQEFBQAEggEAI13So0dgGCv15XdfN+hDFt/Bay2IaqQPqgM2G0f8BUFtaPZT
# eTUJQTCEfM0gkSOeVgYsr9CPXS692cy46Jw7X/cHcaJpQXC8pRvRx0tWOmSPc4s6
# 61iU3FmiDFS0+Gse5m0bIU42jGqSG0aTW9mgTeeZTIu3umHzT9mUSXIkUf1/Op/O
# gZq2dvzpGSbCvabLi1KRd0vjp6g0IDgRHljQJD6+W6b8K9dFakfNPprAF086oUGW
# Tqyba8wfA2fvt7L9IngBjlGRYHl2IjVgtc83pg03u27kEGKuXAu3xHPwuvm5pJQH
# 7c40ByRiaota3Q7A2IWgtuyasRI2qFMS72TYaw==
