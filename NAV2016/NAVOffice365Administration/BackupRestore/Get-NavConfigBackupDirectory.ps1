<#
 .SYNOPSIS
   This cmdlet finds or creates a folder in the temp folder with sub folders specific for Microsoft Dynamics NAV
   and a specific folder under the Backup Id
 ...
 .PARAMETER BackupId
   An identification of the back in order to distinquish it from other backups.
#>
function Get-NavConfigBackupDirectory
{
    [CmdletBinding()]
    param(
    ...
    PROCESS
    {       
        $NavInUserTemp = Join-Path $env:TEMP "Microsoft Dynamics NAV"
        $BackupDirectory = Join-Path $NavInUserTemp "Config Backup $BackupId"
        if (!(Test-Path -PathType Container $BackupDirectory))
        {
            $createdDirectory = New-Item -ItemType Directory $BackupDirectory
        }
...
Export-ModuleMember Get-NavConfigBackupDirectory

# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUv3JyLY0911Md5AfWhGCZcKx6
# +8ygghWCMIIEwzCCA6ugAwIBAgITMwAAAIliDZ6V02FrqAAAAAAAiTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFFbX
# M+6NNOsXohpjB4SmQxqB945kMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBEBgtC++xczzQoEOKhhAw3
# 3DBpFXQTItlgjbiR9cz/xRJB6BtO40smeGjoZMJYU8cTAueEBmgWAuwKPB86Uswv
# nH/kr6mW63zTLnLmMe0DFufx1iyfbzADiuZQ7zTaqcfDZqzFywJWd4V+4KIUGc1S
# hXgvZfDLZu3u1gpQutsursunIAlBm69vro3+PZygzSlybQ02i9xZrxSA0rDkFCt2
# 5I79GLacZ/bCK8Kl30WHfnbifwRR8DHBrtBmrZSk3sR5EMgBZhU2+Qdfer/Zhkdh
# /cOMtOiUB6k2il/Mocfdsm3JUdmJVgG9ekbYx3Si2NmyCrgJ8a2X6Atc27ABF/Wy
...
# NDI1WjAjBgkqhkiG9w0BCQQxFgQUW97vnKOKoCPU8IpvSl/T2mzZNqMwDQYJKoZI
# hvcNAQEFBQAEggEAWLslztkpLOgV9aarWUbkxQXXvHE7P1oUp+Ewh3k0SqCIlLMr
# Xl2MnlM99Ka7MJEbybQ4OgXkC/Rfu2Y4nw4zyb/+mgPT65+NzvywH/boFK9CAoNx
# th1MFwDILaq8Impvt8qlsi/nIDjeEi2sQnHa9yAi5PvhfdI9Y3mC1fNMs3ZBmUHk
# r3DDAtaiL/TBjfdFakivoXgNLoQKEITo25vNkEcuzWtwtfZmgoQOsoTNWmyiPMHF
# UD0a1Rh0k3Hi+R80QMQRuU5uKSFcTKoldCwrxrfBj8sNJPf+ME8v9kQHL3Twgy8d
# w1cUbgDf0/EfiqfSH6dUaXEEkxVhgLByfrF8eA==
