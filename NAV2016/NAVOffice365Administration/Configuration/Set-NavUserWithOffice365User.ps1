<#
 .SYNOPSIS
   This cmdlet finds a Microsoft Dynamics NAV user with the provided user name and updates the AuthenticationEmail to the provided Office 365 Authentication Email.
...
#>
function Set-NavUserWithOffice365User
{
    [CmdletBinding()]
    param(
    ...
    PROCESS
    {
        Write-Verbose "`nUpdate NAV User Account with authentication email. "
        Write-Verbose "`nNAV User Name : $NavUser"

        $navUsers = Get-NavServerUser -ServerInstance $NavServerInstance -Tenant $NavTenant

        $matchNavUser = $navUsers | ? {($_.UserName).ToLower() -eq $NavUser.ToLower()}
        if ($matchNavUser)                                  
        {
            Write-Verbose "`n Found nav user $NavUser"                    
            Set-NAVServerUser `
                -UserName $matchNavUser.UserName `
        ...
        Write-Error "`n Could not find Nav User $NavUser"
		return $false
    }
}
Export-ModuleMember Set-NavUserWithOffice365User
# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULgHYShoCsuFbMXexySxu3HuO
# su2gghWCMIIEwzCCA6ugAwIBAgITMwAAAIpX6omjSeuL6AAAAAAAijANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEwt
# E07WL9omqSR4+O7ZFAx5/CEMMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBkXbmXoIUHGFhGlMmS4DDx
# X04RkXYSjan+qLsCubu04PJRtuU3nm6FL4EaJc+VBdQ0v8PepvI/oK3R/SE8ayoV
# tjOQjZbkKiUNme8GqDo8NBy+lSWRx7yqWIQJ25CXIUirGDOjg1YVV2Y3VtQKPp5j
# sT1YK0QkZxD982xEGq56l3GXRH71yj2ynwDFkyUYDJhil/WSXyEdhQhXzNISUBn7
# BmDzvESscIqs3Xp9jDa8yQqdSlsIUehZnEo8pWEApNTA6eq1yn2Gut42BDCz04W2
# ztVxs+qn+XHYoxmgEWAcDIEa3RFnql6KFZvUGlLCvpoSIEIySoCtq8CUWyD14PTj
...
# NDI1WjAjBgkqhkiG9w0BCQQxFgQUjhbjrqKz2f80UODEPPDsVCPneJAwDQYJKoZI
# hvcNAQEFBQAEggEAwMUiWk0SkYA7kryAOsxIJ9J/KjoWwPJr+BU3jnG4XUEClXgt
# Vdf3XrtAAdVNtz/NdfdyxRzJX09VRbZCl4KVFWsdJK0UOKNiBb/9zbttCsyKDiLk
# f0q72HMG/aUxGsipWMMj+TIre8DBbf5RQQixaYnzzXryqW3oVCRB/0xLG+Iy03Ge
# XZUF5S6BDGKSME6zlaoS1R3XhzseT93qTgla+55y8C7uRTV3qY2JyX3hy8C/fRLm
# aMpt7ytmHalQ4ryYyqS4AJ6R6WXPXCYvu8BQ0L3tmMkSE1Vmd6JJhMdKOO3cp2ec
# ITuhhhOlew6KeZVlRL/VzXuWEuGfa/KM7o+YXw==
