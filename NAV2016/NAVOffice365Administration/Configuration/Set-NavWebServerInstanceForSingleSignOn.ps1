<#
 .SNOPSIS
   This cmdlet changes the Nav Web Server Settings in order to prepare the Web Client for AAD Authentication.
 ...
 .PARAMETER AadTenantDomain
   Specifies the domain of the AAD tenant which will perform the federated authentication.
 .PARAMETER NavWebServerRealm
   Specifies the realm of the NAV Web Client which is also specified when creating a Service Principal for the NAV Web Client in AAD.
 .PARAMETER CertificateDnsIdentity
   Specifies the domain name for the authority which the server's security certificate was issued for.
#>
function Set-NavWebServerInstanceForSingleSignOn
{
    [CmdletBinding()]
    param(
        ...
        [parameter(Mandatory=$true)]
        [string] $NavWebServerAppIdUri,

        [parameter(Mandatory=$true)]
        [string] $CertificateDnsIdentity
    )
    PROCESS
    {
		Write-Verbose "Changing the web.config for the following Web Server instance: $NavWebServerInstanceName."

        Set-NAVWebServerInstanceConfiguration -WebServerInstance $NavWebServerInstanceName -KeyName ClientServicesCredentialType -KeyValue AccessControlService
        Set-NAVWebServerInstanceConfiguration -WebServerInstance $NavWebServerInstanceName -KeyName ACSUri -KeyValue "https://login.windows.net/$AadTenantDomain/wsfed?wa=wsignin1.0%26wtrealm=$NavWebServerAppIdUri"
        Set-NAVWebServerInstanceConfiguration -WebServerInstance $NavWebServerInstanceName -KeyName DnsIdentity -KeyValue $CertificateDnsIdentity
    }
}

Export-ModuleMember Set-NavWebServerInstanceForSingleSignOn

# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU94H6p56qlEsjGekENAXGpJpu
# N0GgghWCMIIEwzCCA6ugAwIBAgITMwAAAIpX6omjSeuL6AAAAAAAijANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFODx
# kUntOOL9/hPIRqytmU8KjIUvMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQBjhB+KOoQ8EGc466K21nWC
# idKc0vQDOqca+q393wXF8/2WTrzt/XqWQ4JivMLCkd+jP+VehSBOEegNrX6lHqPv
# Ql/wNXcV4065YyvnbP82RcPHSTlWf06t0O8wUis4RG5TXyiGIhfQehhjuoMVcpzJ
# 5yLVLxfbVoLq0cjhmVT/rTwcj16wODsYjCdCvl2FtwKnEOlYsKgZAgdK5oPtNLFE
# zAbXoTm4aNiO3OF1GwL9OdW9VelDReWMDdH55jFWMIY7YSJGlXqjYBsL1j4D9KVh
# of/ogejNrnvmkdJ4leMCq1uzfs8O7B+iGR4v40BVgsjFG/bubznJhQcXWkZDLuhu
...
# NDI1WjAjBgkqhkiG9w0BCQQxFgQUCCrMXI3V2nfnqW5GfI9zQnpm2wQwDQYJKoZI
# hvcNAQEFBQAEggEAKj4MTX5chi9+HAw4/9tnQM/3nY396qOGBe1P3ze1Z/uMgE4+
# FFJkhz+VH9PvLix+Wml90rfd7Yim2To3z4ZGJEgXnFA9KrhBZw4IrdvCu1bfdtba
# X3xsmwqXhikJejj6j5uQYhAW22+oumYD2DoDQNkyKvVxg3wPMpwIp2dZ9Mc1C6ev
# 61x1ius/F6jIvhIt3Vw2r48Vl32KIPbbhUc3nLgkZYi7KgWMEf6I6/SjkmCdmcsW
# 8/QXKNrziN57mUQ5SKkNRxXclQlqiqQJ/OMnDO8NXVXGVRhNMp7+fWC1TuKwkoyj
# yTPi3Ys3k1pp2MSXVEiL2i8qqsaXRhe3Kv5aZw==
