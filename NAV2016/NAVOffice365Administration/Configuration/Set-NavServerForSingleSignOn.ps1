<#
.SYNOPSIS
   This cmdlet updates the server configuration with Single Sign On settings

.DESCRIPTION
   This cmdlet updates the server configuration with Single Sign On settings
.PARAMETER NavServerInstance
    The server instance to configure
.PARAMETER AadTenantDomain
    The AAD tenant name to enable Single Sign On for.
.PARAMETER NavServerCertificateThumbprint
    The Nav Server Certificate Thumbprint used to secure the communication
#>
function Set-NavServerForSingleSignOn        
{
    [CmdletBinding()]
    param(
    ...
    PROCESS
    {
        # Update values in NST config file
        Write-Verbose "Update config file with AAD parameters "
                          
        $fedMetadataUri = "https://login.windows.net/$AadTenantDomain/federationmetadata/2007-06/federationmetadata.xml"
        $credentialTypeValue = "NavUserPassword"
    
        Set-NavServerConfiguration $NavServerInstance -KeyName ClientServicesFederationMetadataLocation -KeyValue $fedMetadataUri
        Set-NavServerConfiguration $NavServerInstance -KeyName ClientServicesCredentialType -KeyValue $credentialTypeValue
        Set-NavServerConfiguration $NavServerInstance -KeyName ServicesCertificateThumbprint -KeyValue $NavServerCertificateThumbprint
        Set-NavServerConfiguration $NavServerInstance -KeyName AppIdUri -KeyValue $AppIdUri
    }
}

Export-ModuleMember Set-NavServerForSingleSignOn
# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUsZ466E5zfq22/VslYPgpjPRf
# Gl2gghWCMIIEwzCCA6ugAwIBAgITMwAAAIliDZ6V02FrqAAAAAAAiTANBgkqhkiG
...
# u0zRDkoRkM1cq21Ud1Md7HJSMIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQB5L4j+a0GbZqLzn59mymUG
# FKemDfgBpuK7bBBbq0z+26A7yQNs2fwMAoM1h5rRiQIzqQi8rUiJsz4xjHj8k66v
# PTj/G14lCIzo5eeq8SweCTlTnFWPvBAQoQsUFq+oYnA8pfMT5bznkGOAb4GfJgCJ
# hIJNht1udmWUx1WdbQFJ8Q6JYg0gMsrIAipR63CuFHSzTuQiv/2TiwuNv5phh8p9
# fZMVi8A59x8qCzlcVAVDO9NgrLWZftfD/nFFIKxpy4ZHejgcVFRp3nYNUZFOou8+
# +m4LMVTKh8kqaGoxFpOglkOY7qWVvg7RGtFRM82RiA7psyaLyKrYcqYxu5TiZ7Xb
...
# NDI1WjAjBgkqhkiG9w0BCQQxFgQUNmDnwuAIK32VFG9LOvLPR/UpZDUwDQYJKoZI
# hvcNAQEFBQAEggEAHWHrA3RmGBjahjiC04bYHMdqdoBKahICrBw+uS48TPZwKr4y
# +Bvlae45VsfFK8FCK1oTREb6oUcaEbSiuSu1sUcGUPib/EYmOHS7Yl3kttUaDQTX
# XUcvz20bc+LVt8EknEPSUoy7Z3Ulq+5Txcyd9GSFQ2YB3iYrySNlnz03l3HXEJFf
# yIg+PW3FIvWmPkTPOvYBaqDnMdpALddv02n9eBT/37LGl3t2yqqa808FeDeVt0fx
# nIutaCjGTYIxtd1Hm31H4FNsg+ANaLsWOJAZhNN8Ju1BtrBEufme4F02LvlCB1cJ
# 70jnBa0em55G96kAdjSe9SfF+KoBtwAZ0Qz5Cg==
