...
. (Join-Path $PSScriptRoot 'Set-NavSingleSignOnWithOffice365.ps1')

. (Join-Path $PSScriptRoot 'BackupRestore\Get-NavConfigBackupDirectory.ps1')
. (Join-Path $PSScriptRoot 'BackupRestore\Backup-NavAllServerConfiguration.ps1')
. (Join-Path $PSScriptRoot 'BackupRestore\Restore-NavConfiguration.ps1')

. (Join-Path $PSScriptRoot 'Configuration\Get-Office365AuthAcsUriForWinClient.ps1')
. (Join-Path $PSScriptRoot 'Configuration\Set-NavWinClientForSingleSignOn.ps1')
. (Join-Path $PSScriptRoot 'Configuration\Set-AadServicePrincipalForSingleSignOn.ps1')
. (Join-Path $PSScriptRoot 'Configuration\Set-NavServerForSingleSignOn.ps1')
. (Join-Path $PSScriptRoot 'Configuration\Set-NavUserWithOffice365User.ps1')
. (Join-Path $PSScriptRoot 'Configuration\Set-NavWebServerInstanceForSingleSignOn.ps1')

. (Join-Path $PSScriptRoot 'Utilities\Connect-Office365.ps1')
. (Join-Path $PSScriptRoot 'Utilities\Import-NAVManagementModule.ps1')
. (Join-Path $PSScriptRoot 'Utilities\Get-NavCertificateDnsName.ps1')
# SIG # Begin signature block
# MIIa6AYJKoZIhvcNAQcCoIIa2TCCGtUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8TSACnf3H6f4JDh56RGqFLYY
# FxSgghWCMIIEwzCCA6ugAwIBAgITMwAAAIliDZ6V02FrqAAAAAAAiTANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFKs0
# AdWXZyAjOStXbZikaezmzmq1MIGIBgorBgEEAYI3AgEMMXoweKBagFgATQBpAGMA
...
# bWljcm9zb2Z0LmNvbTANBgkqhkiG9w0BAQEFAASCAQAD8RMFXD6rRuUyJcknkGQ7
# 6bh5mQBQVZZOrNt4ZREnYiGxS1GEH51KaWw7Oa1pkgFj3Aq9FQBjUPU4ANrtUAVz
# va7zlFjM78dtYYO3idFDHQirIazF9hWSAfL2eoEBHS4o3X/YMswRcB8EuvBG2qJr
# 6sTg5jZq6VNaopO0RfiYDYMR3k8AyCcPcVfqwaK0LIu2VI7vTemZzmY9eJP77NT5
# iz3a5hTu/TGuYaMFMWkymYQHcHF8ULicNQxNbATb/seA5NLM00z9sB7Fo2kA8ePd
# Pf8ueL/q7/oUYKgS2zbEm97ql9EG2v+0Gwl837Ph40oWQ863Lpa/8Z5zPU35xmNN
...
# NDI2WjAjBgkqhkiG9w0BCQQxFgQUhl/K4LX6W4Y8yILHrp60n/++VFswDQYJKoZI
# hvcNAQEFBQAEggEAJDMQ4kyCkR5emtwTQwo1oysEeNfW5+97Wl8u+B6WVagEBdhU
# MzfoahJCiZYb0EAM3cWywQBKRtyisG6PsnMS0mAc80yqNtmYvTegutHE9bfwTlBe
# SScI0EUueq+OiyPHiA4j4gcxmUPiOVKsyrUodGcGX2nS5hjaVcARcXOxWXJEQjEs
# Xy/TJkTwoFBKMHsYaK5uV4+7BaPc2Bgrgq7n0uaZ3F399rDUATs/kF2z3FoslrpZ
# tAISFVo0VrJDGFc+Wi3tpH3Da4OFc5t/morkYjOuvyFxtRwI48l50RGamLTSvAOQ
# 5blE0ogFUR1aJqeP7tcgC8b0p0V+SOvgqS0vvw==
