...
$Mysearchbase = "DC=SI-DATA,DC=SI-DATA,DC=no" 
$Mysearchbase = '';
...
$myuserlist = Import-csv "C:\Users\jal\Documents\NAV\Script\Data files\Users.csv" 
...
$list = Import-csv -Path "C:\Users\jal\Documents\NAV\Script\Data files\Users.csv" -Delimiter ';' -Header username,roleset
